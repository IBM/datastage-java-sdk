...
<head>
    ...
    <title>IBM Cloud DataStage</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" crossorigin="anonymous">
</head>
<body>
<div class="container">
    <div class="page-header">
        <h1>IBM Cloud DataStage Java SDK Documentation</h1>
    </div>

    <p><a href="https://cloud.ibm.com/apidocs?category=datastage">DataStage Info</a>
        | <a href="https://github.ibm.com/ibmcloud/datastage-java-sdk">GitHub</a>
    </p>
