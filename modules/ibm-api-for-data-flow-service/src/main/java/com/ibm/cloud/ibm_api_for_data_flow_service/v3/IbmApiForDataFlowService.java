 ...
 * @version v3
 */
public class IbmApiForDataFlowService extends BaseService {

  public static final String DEFAULT_SERVICE_NAME = "ibm_api_for_data_flow_service";

  public static final String DEFAULT_SERVICE_URL = "https://ibm-api-for-data-flow-service.cloud.ibm.com/data_intg";

 /**
   * Class method which constructs an instance of the `IbmApiForDataFlowService` client.
   * The default service name is used to configure the client instance.
   *
   * @return an instance of the `IbmApiForDataFlowService` client using external configuration
   */
  public static IbmApiForDataFlowService newInstance() {
   ...
   * @return an instance of the `IbmApiForDataFlowService` client using external configuration
   */
  public static IbmApiForDataFlowService newInstance(String serviceName) {
    Authenticator authenticator = ConfigBasedAuthenticatorFactory.getAuthenticator(serviceName);
    IbmApiForDataFlowService service = new IbmApiForDataFlowService(serviceName, authenticator);
    service.configureService(serviceName);
    return service;
  }

  /**
   * Constructs an instance of the `IbmApiForDataFlowService` client.
   * The specified service name and authenticator are used to configure the client instance.
   *
   * @param serviceName the service name to be used when configuring the client instance
   * @param authenticator the {@link Authenticator} instance to be configured for this client
   */
  public IbmApiForDataFlowService(String serviceName, Authenticator authenticator) {
  ...
  public ServiceCall<DataFlowPagedCollection> datastageFlowsList(DatastageFlowsListOptions datastageFlowsListOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "datastageFlowsList");
  ...
  public ServiceCall<DataIntgFlow> datastageFlowsCreate(DatastageFlowsCreateOptions datastageFlowsCreateOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "datastageFlowsCreate");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json;charset=utf-8");
  ...
  public ServiceCall<Void> datastageFlowsDelete(DatastageFlowsDeleteOptions datastageFlowsDeleteOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "datastageFlowsDelete");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
  ...
  public ServiceCall<DataIntgFlow> datastageFlowsGet(DatastageFlowsGetOptions datastageFlowsGetOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "datastageFlowsGet");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json;charset=utf-8");
  ...
  public ServiceCall<DataIntgFlow> datastageFlowsUpdate(DatastageFlowsUpdateOptions datastageFlowsUpdateOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "datastageFlowsUpdate");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json;charset=utf-8");
  ...
  public ServiceCall<DataIntgFlow> datastageFlowsClone(DatastageFlowsCloneOptions datastageFlowsCloneOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "datastageFlowsClone");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json;charset=utf-8");
  ...
  public ServiceCall<FlowCompileResponse> datastageFlowsCompile(DatastageFlowsCompileOptions datastageFlowsCompileOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "datastageFlowsCompile");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json;charset=utf-8");
  ...
  public ServiceCall<ImportResponse> migrationCreate(MigrationCreateOptions migrationCreateOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "migrationCreate");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json;charset=utf-8");
  ...
  public ServiceCall<ImportResponse> migrationGet(MigrationGetOptions migrationGetOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "migrationGet");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json;charset=utf-8");
  ...
  public ServiceCall<Void> migrationDelete(MigrationDeleteOptions migrationDeleteOptions) {
    ...
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("ibm_api_for_data_flow_service", "v3", "migrationDelete");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
