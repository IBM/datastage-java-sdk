 ...
 */
public class ListDatastageSubflowsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListDatastageSubflowsOptions listDatastageSubflowsOptions) {
      this.catalogId = listDatastageSubflowsOptions.catalogId;
      this.projectId = listDatastageSubflowsOptions.projectId;
      this.sort = listDatastageSubflowsOptions.sort;
      this.start = listDatastageSubflowsOptions.start;
      this.limit = listDatastageSubflowsOptions.limit;
      this.entityName = listDatastageSubflowsOptions.entityName;
      this.entityDescription = listDatastageSubflowsOptions.entityDescription;
    }
    ...
    /**
     * Builds a ListDatastageSubflowsOptions.
     *
     * @return the new ListDatastageSubflowsOptions instance
     */
    public ListDatastageSubflowsOptions build() {
      return new ListDatastageSubflowsOptions(this);
    }
     ...
     * @return the ListDatastageSubflowsOptions builder
     */
  ...
  protected ListDatastageSubflowsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListDatastageSubflowsOptions builder
   */
