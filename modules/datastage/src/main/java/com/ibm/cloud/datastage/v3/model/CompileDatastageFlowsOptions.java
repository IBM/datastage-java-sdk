 ...
 */
public class CompileDatastageFlowsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(CompileDatastageFlowsOptions compileDatastageFlowsOptions) {
      this.dataIntgFlowId = compileDatastageFlowsOptions.dataIntgFlowId;
      this.catalogId = compileDatastageFlowsOptions.catalogId;
      this.projectId = compileDatastageFlowsOptions.projectId;
      this.runtimeType = compileDatastageFlowsOptions.runtimeType;
    }
    ...
    /**
     * Builds a CompileDatastageFlowsOptions.
     *
     * @return the new CompileDatastageFlowsOptions instance
     */
    public CompileDatastageFlowsOptions build() {
      return new CompileDatastageFlowsOptions(this);
    }
     ...
     *
     * @param dataIntgFlowId the dataIntgFlowId
     * @return the CompileDatastageFlowsOptions builder
     */
  ...
  protected CompileDatastageFlowsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a CompileDatastageFlowsOptions builder
   */
