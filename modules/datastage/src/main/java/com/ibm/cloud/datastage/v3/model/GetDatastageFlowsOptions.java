 ...
 */
public class GetDatastageFlowsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetDatastageFlowsOptions getDatastageFlowsOptions) {
      this.dataIntgFlowId = getDatastageFlowsOptions.dataIntgFlowId;
      this.catalogId = getDatastageFlowsOptions.catalogId;
      this.projectId = getDatastageFlowsOptions.projectId;
    }
    ...
    /**
     * Builds a GetDatastageFlowsOptions.
     *
     * @return the new GetDatastageFlowsOptions instance
     */
    public GetDatastageFlowsOptions build() {
      return new GetDatastageFlowsOptions(this);
    }
     ...
     *
     * @param dataIntgFlowId the dataIntgFlowId
     * @return the GetDatastageFlowsOptions builder
     */
  ...
  protected GetDatastageFlowsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetDatastageFlowsOptions builder
   */
