 ...
 */
public class ListDatastageFlowsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListDatastageFlowsOptions listDatastageFlowsOptions) {
      this.catalogId = listDatastageFlowsOptions.catalogId;
      this.projectId = listDatastageFlowsOptions.projectId;
      this.sort = listDatastageFlowsOptions.sort;
      this.start = listDatastageFlowsOptions.start;
      this.limit = listDatastageFlowsOptions.limit;
      this.entityName = listDatastageFlowsOptions.entityName;
      this.entityDescription = listDatastageFlowsOptions.entityDescription;
    }
    ...
    /**
     * Builds a ListDatastageFlowsOptions.
     *
     * @return the new ListDatastageFlowsOptions instance
     */
    public ListDatastageFlowsOptions build() {
      return new ListDatastageFlowsOptions(this);
    }
     ...
     * @return the ListDatastageFlowsOptions builder
     */
  ...
  protected ListDatastageFlowsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListDatastageFlowsOptions builder
   */
