 ...
 */
public class GetDatastageSubflowsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetDatastageSubflowsOptions getDatastageSubflowsOptions) {
      this.dataIntgSubflowId = getDatastageSubflowsOptions.dataIntgSubflowId;
      this.catalogId = getDatastageSubflowsOptions.catalogId;
      this.projectId = getDatastageSubflowsOptions.projectId;
    }
    ...
    /**
     * Builds a GetDatastageSubflowsOptions.
     *
     * @return the new GetDatastageSubflowsOptions instance
     */
    public GetDatastageSubflowsOptions build() {
      return new GetDatastageSubflowsOptions(this);
    }
     ...
     *
     * @param dataIntgSubflowId the dataIntgSubflowId
     * @return the GetDatastageSubflowsOptions builder
     */
  ...
  protected GetDatastageSubflowsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetDatastageSubflowsOptions builder
   */
