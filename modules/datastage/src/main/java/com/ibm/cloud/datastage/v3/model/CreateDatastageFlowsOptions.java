 ...
 */
public class CreateDatastageFlowsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(CreateDatastageFlowsOptions createDatastageFlowsOptions) {
      this.dataIntgFlowName = createDatastageFlowsOptions.dataIntgFlowName;
      this.pipelineFlows = createDatastageFlowsOptions.pipelineFlows;
      this.catalogId = createDatastageFlowsOptions.catalogId;
      this.projectId = createDatastageFlowsOptions.projectId;
      this.assetCategory = createDatastageFlowsOptions.assetCategory;
    }
    ...
    /**
     * Builds a CreateDatastageFlowsOptions.
     *
     * @return the new CreateDatastageFlowsOptions instance
     */
    public CreateDatastageFlowsOptions build() {
      return new CreateDatastageFlowsOptions(this);
    }
     ...
     *
     * @param dataIntgFlowName the dataIntgFlowName
     * @return the CreateDatastageFlowsOptions builder
     */
  ...
  protected CreateDatastageFlowsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a CreateDatastageFlowsOptions builder
   */
