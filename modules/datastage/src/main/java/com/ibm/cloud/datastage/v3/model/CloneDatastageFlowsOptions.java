 ...
 */
public class CloneDatastageFlowsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(CloneDatastageFlowsOptions cloneDatastageFlowsOptions) {
      this.dataIntgFlowId = cloneDatastageFlowsOptions.dataIntgFlowId;
      this.catalogId = cloneDatastageFlowsOptions.catalogId;
      this.projectId = cloneDatastageFlowsOptions.projectId;
    }
    ...
    /**
     * Builds a CloneDatastageFlowsOptions.
     *
     * @return the new CloneDatastageFlowsOptions instance
     */
    public CloneDatastageFlowsOptions build() {
      return new CloneDatastageFlowsOptions(this);
    }
     ...
     *
     * @param dataIntgFlowId the dataIntgFlowId
     * @return the CloneDatastageFlowsOptions builder
     */
  ...
  protected CloneDatastageFlowsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a CloneDatastageFlowsOptions builder
   */
