...
/**
 * Unit test class for the CreateDatastageFlowsOptions model.
 */
public class CreateDatastageFlowsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateDatastageFlowsOptions() throws Throwable {
    ...
    CreateDatastageFlowsOptions createDatastageFlowsOptionsModel = new CreateDatastageFlowsOptions.Builder()
      ...
      .build();
    assertEquals(createDatastageFlowsOptionsModel.dataIntgFlowName(), "testString");
    assertEquals(createDatastageFlowsOptionsModel.pipelineFlows(), pipelineJsonModel);
    assertEquals(createDatastageFlowsOptionsModel.catalogId(), "testString");
    assertEquals(createDatastageFlowsOptionsModel.projectId(), "bd0dbbfd-810d-4f0e-b0a9-228c328a8e23");
    assertEquals(createDatastageFlowsOptionsModel.assetCategory(), "system");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateDatastageFlowsOptionsError() throws Throwable {
    new CreateDatastageFlowsOptions.Builder().build();
  }
