...
/**
 * Unit test class for the DatastageFlowsUpdateOptions model.
 */
public class DatastageFlowsUpdateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDatastageFlowsUpdateOptions() throws Throwable {
    ...
    DatastageFlowsUpdateOptions datastageFlowsUpdateOptionsModel = new DatastageFlowsUpdateOptions.Builder()
      ...
      .build();
    assertEquals(datastageFlowsUpdateOptionsModel.dataIntgFlowId(), "testString");
    assertEquals(datastageFlowsUpdateOptionsModel.dataIntgFlowName(), "testString");
    assertEquals(datastageFlowsUpdateOptionsModel.pipelineFlows(), pipelineJsonModel);
    assertEquals(datastageFlowsUpdateOptionsModel.catalogId(), "testString");
    assertEquals(datastageFlowsUpdateOptionsModel.projectId(), "bd0dbbfd-810d-4f0e-b0a9-228c328a8e23");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDatastageFlowsUpdateOptionsError() throws Throwable {
    new DatastageFlowsUpdateOptions.Builder().build();
  }
